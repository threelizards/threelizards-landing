...
const ContactSection = async () => {
  ...
  return (
    <section className='relative bg-secondary max-w-7xl p-10 my-10 rounded-lg shadow-md text-white text-center'>
      ...
      <Button
        variant='ghost'
        className='max-w-40 mx-auto my-4 text-white border-white'
        as={Link}
